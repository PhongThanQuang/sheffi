...
import logo from '../assets/images/logoshefi.png'
      ...
      <div className="row">
        <div className="d-flex align-items-center justify-content-between d-none d-md-flex">
          <div className="col-md-8 me-auto">
            <p className='text-black'>Get the latest gear, tips, and inspiration. Sign up</p>
          </div>
          <div className="col-md-3">
          <div className="row">
            <div className='col-md-4'>
            <Link className='links fs-4'><GoLocation/><a href="tel:+"><p>Store Locator</p></a ></Link>
          </div> 
    
              <div className='col-md-4'>
                <Link className='links fs-4'><CiMail /><p>Gift Cards</p></Link>             
              </div>
              <div className='col-md-4'>
              <Link className='links fs-4'><BsQuestionOctagon /></Link>
              <p>Get Help</p>
              </div>
