...
import MenuBanner from '../components/shefi';

const home = () => {
  return <>
  <header style={{backgroundColor: '#c3dacc86'}} className='menu-banner-active'>
    <MenuBanner />
  </header>
            ...
            <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                  <div className='back-details'>
                    <video className='back-video' src="src/assets/images/backhome.mp4" autoPlay playsInline muted loop ></video>
                    <div className='menu-banner'>
                      <h1 className='menu-banner-links'>SheFi</h1>
                      <ul className='menu-banner-links__1Rnb'>
                        <li className='lll-text-body-1'>
                          <a href="">Gifts for All</a>
                        </li>
                        <li className='lll-text-body-1'>
                          <a href="">Wommens Whats New</a>
                        </li>
                        <li className='lll-text-body-1'>
                          <a href="">All Wommens</a>
                        </li>
                        <li className='lll-text-body-1'>
                          <a href="">All Mens</a>
                        </li>
